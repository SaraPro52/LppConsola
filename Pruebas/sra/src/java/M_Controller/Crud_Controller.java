...
//                     opSelect: 4
//                     num:2};
            String Rdatos = request.getParameter("data");
            String dat[] = Rdatos.split(",");
            ArrayList<String> dato = new ArrayList<String>();
            System.out.println(dat);
            int con =Integer.parseInt(dat[6]);
            for (int i = 1; i <= con; i++) {
                dato.add(dat[6+i]);
            }
            ...
            tipoElo = 1;
            option = Integer.parseInt(dat[1]);
            tabla = Integer.parseInt(dat[2]);
            delimitador = "";
            actualizar = request.getParameter("actualizar");
            optionSelect = Integer.parseInt(dat[5]);
            id = Integer.parseInt(dat[4]);

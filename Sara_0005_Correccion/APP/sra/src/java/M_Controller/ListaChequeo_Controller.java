...
public class ListaChequeo_Controller extends HttpServlet {
        ...
        response.setContentType("text/html;charset=UTF-8");
         try (PrintWriter out = response.getWriter()) {
            ...
            switch (opcion) {
                ...
                case 2:
                    ...
                    try {
                        if(listaC.ModificarLista(mLista, mitems)){
                            String resulta = listaModificar(jData.getInt("idUser"),jData.getInt("idRol")); //24/04/2017
                ...
                case 5:
                     //24/04/2017
                    String resulta = listaModificar(jData.getInt("idUser"),jData.getInt("idRol"));
                    if(resulta != "false")
    ...
    //24/04/2017
    public static String listaModificar(int idUser,int idRol){
        try {
            String[] columnas = {"0","1","2","3"};
            String delimitador = "[{colum:4,operador:0,valor1:" + idUser + ",añadir:0},{colum:5,operador:0,valor1:" + idRol + "}]";

...
public class Tipo_Version_Bean {
    ...
    private String Des_Version;
    
    public Tipo_Version_Bean(){}
    
    public Tipo_Version_Bean(String nom_TipoV, String des_Version){
        
        this.Nom_Tipo_Version = nom_TipoV;
        this.Des_Version = des_Version;
    }
    ...
    public String getDes_Version() {
        return Des_Version;
    }

    public void setDes_Version(String Des_Version) {
        this.Des_Version = Des_Version;
    }

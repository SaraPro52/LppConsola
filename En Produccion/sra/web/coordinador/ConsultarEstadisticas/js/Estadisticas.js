$(document).ready(function () {
    ...
    datos[0] = {nombre: "btn", worker: true, btn: false};
    ajax(0, datos[0]);
    ...
    $("#btnAreaE").click(function () {
        ...
        datos[1] = {nombre: "btn", worker: true, btn: true};
        ajax(1, datos[1]);
    });
    ...
    $("#btnProductoE").click(function () {
        ...
        selector[0] = "ProductoirtualE";
        datos[0] = {nombre: "btn", worker: true, btn: true};
        ajax(0, datos[0]);
    });
    ...
    $("#btnCategoriaE").click(function () {
        ...
        datos[2] = {nombre: "btn", worker: true,btn:true};
        ajax(2, datos[2]);
    });
        ...
        try {
            if (i == 0) {
                ...
                if (datos[0].btn == false) {
                    ...
                    datos[1] = {nombre: "btn", worker: true, btn: false};
                    ajax(1, datos[1]);
                }
                ...
                if (datos[1].btn == false) {
                    ...
                    datos[2] = {nombre: "btn", worker: true,btn:false};
                    ajax(2, datos[2]);
                }
            } else if (i == 2) {

$(document).ready(function () {
    ...
    jso[0] = ['Crud_Controller', '[{opcion3,tabla2:31,tipo:2,elegir:[0,1,2],delimitador:"[{colum:3,operador:0,valor1:' + idCentro + '}]",id:0,opSelect:6}]'];
        ...
        try {
            if (i == 0) {
                ...
                for (var i = 0; i < js.length; i++) {
                    datas.push({"label": js[i].Nombre, "value": js[i].valor});
                }

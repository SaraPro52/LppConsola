...
$(document).on('click', '.btnCorrecion', function (e) {
    //verdadera//jso[1] = ['EvaluacionGeneral_Controller', '[{opcion:2,idEvalua:' + idEvalua + ',resultado:0}]'];
    ob.limpiarTablaI($("#tablaNotificacion"));
    jso[1] = ['Crud_Controller', '[{opcion:3,tabla2:17,tipo:2,elegir:[4,5,6,7],delimitador:"[{colum:2,operador:0,valor1:' + idRol + ',añadir:0},{colum:10,operador:0,valor1:' + idCentro + ',añadir:0},{colum:0,operador:0,valor1:' + idUser + ',añadir:0},{colum:11,operador:0,valor1:2,añadir:0},{colum:9,operador:0,valor1:0}]",id:0,opSelect:6}]'];

$(document).ready(function () {
    ...
    $("#btnACategoriaF").click(function () {
        ...
        clonCategoria.find("#buttonPro").val('ProSelect' + countC);
        clonCategoria.find(".contenPro").attr('id', 'ProSelect' + countC);
        clonCategoria.find(".arrayPro").attr('id', 'aProSelect' + countC);
        clonCategoria.find("#aProSelect" + countC).attr('text', '[' + arraySelecionEstr + ']');

...
//
//            EstructuraDB co = new EstructuraDB();
//            co.Creacion();
//          String[] filtros = new String[7];
//          
//          filtros[0]="0";//Nom o id Producto virtual
//          filtros[1]="";//Id Formato
//          filtros[2]="2017/04/15";//Fecha Inicial o Fecha unica
//          filtros[3]="2017/04/15";//Fecha finalS
//          filtros[4]="";//Nom o id Funcionario
//          filtros[5]="";//Categoria o Programa 
//          filtros[6]="";//tipoTEMA C O P
//          
//          int caso = 1;// 0 trae la consulta sin ningun filtro-- 1 inicia el proceso para validar que se le envian filtros
//          
...
//        d.setDate(31);
//        //d.setYear(2017);
//        System.out.println(d.getDate());//dia mes
//        String anio = ""+d.getYear();
//        anio = "20"+anio.substring(1, anio.length());
...
//        String[] para1 = {"1","0","TipoFormato04","UrlTipoFormato004"};
//        System.out.println(new Formato().TipoFormatoAdmin(para1));
        
//        String[] para2 = {"2","5","TipoFormato005","UrlTipoFormato003"};
//        System.out.println(new Formato().TipoFormatoAdmin(para2));
    
//         String[] para3 = {"0","0","0","0"};
//        System.out.println(new Formato().TipoFormatoAdmin(para3));

...
--
CALL SARA_CRUD("INSERT","Funcionario","Id_Tipo_Documento~1	|Num_Documento~1019133595	|Nom_Funcionario~Miguel Alfredo	|Apellidos~Sanchez Cabanzo		|Correo~Macastiblanco88@misena.edu.co	|Cargo~Instructor	|Ip_Sena~159753	|Contraseña~macc	|Id_Area_Centro~1","");
CALL SARA_CRUD("INSERT","Funcionario","Id_Tipo_Documento~1	|Num_Documento~1039598334	|Nom_Funcionario~Carlos Oracio	|Apellidos~Diaz Buitrago		|Correo~cdiazbu@misena.edu.co			|Cargo~Instructor	|Ip_Sena~555555	|Contraseña~judini	|Id_Area_Centro~1","");
CALL SARA_CRUD("INSERT","Funcionario","Id_Tipo_Documento~2	|Num_Documento~1729938448	|Nom_Funcionario~Sandra			|Apellidos~Gonzales Ribero		|Correo~sandra@misena.edu.co			|Cargo~Pedagoga		|Ip_Sena~680884	|Contraseña~595959	|Id_Area_Centro~1","");
CALL SARA_CRUD("INSERT","Funcionario","Id_Tipo_Documento~3	|Num_Documento~1039598338	|Nom_Funcionario~Juan Alejandro	|Apellidos~Rodriguez Mogollon	|Correo~jarm@misena.edu.co				|Cargo~Coordinador	|Ip_Sena~957595	|Contraseña~admin	|Id_Area_Centro~1","");
CALL SARA_CRUD("INSERT","Funcionario","Id_Tipo_Documento~2	|Num_Documento~1319497750	|Nom_Funcionario~Estevan		|Apellidos~Castro				|Correo~ecastro@misena.edu.co			|Cargo~Tecnico		|Ip_Sena~957597	|Contraseña~otmoe	|Id_Area_Centro~1","");
--
...
--
CALL SARA_CRUD("INSERT","Version","Fecha_Publicacion~2016-03-10	|Num_Version~1|Fecha_Vigencia~2016-09-10|Url_Version~/carpeta1/carpeta2|Url_Img~/carp1/carp2|Inst_Instalacion~Descargue el archivo y ejecutelo en cualquier editor de texto			|Reqst_Instalacion~Editor de texto, Acceso a internet			|Id_P_Virtual~1|Id_Estado~6|Id_Tipo_Version~2","");
CALL SARA_CRUD("INSERT","Version","Fecha_Publicacion~2016-06-01	|Num_Version~1|Fecha_Vigencia~2017-12-10|Url_Version~/carpeta1/carpeta2|Url_Img~/carp1/carp2|Inst_Instalacion~Descargue el archivo y ejecutelo en cualquier visualizador de imagenes|Reqst_Instalacion~Visualizador de imagenes, Acceso a internet	|Id_P_Virtual~2|Id_Estado~6|Id_Tipo_Version~2","");
-- CALL SARA_CRUD("INSERT","Version","Num_Version~1	|Url_Version~	|Url_Img~	|Inst_Instalacion~Descargue el archivo y ejecutelo en cualquier editor de texto			|Reqst_Instalacion~Editor de texto, Acceso a internet			|Id_P_Virtual~1	","");
CALL SARA_CRUD("INSERT","Version","Num_Version~1	|Url_Version~	|Url_Img~	|Inst_Instalacion~Descargue el archivo y ejecutelo en cualquier visualizador de imagenes|Reqst_Instalacion~Visualizador de imagenes, Acceso a internet	|Id_P_Virtual~2	","");
--
...
--
CALL SARA_CRUD("INSERT","Evaluacion_General","Observacion~el oa no cumple con los items|Resultado~0|Id_Version~3|Id_Lista_Chequeo~1|Id_Funcionario~2","");
...
-- CALL SARA_CRUD("UPDATE","Version","Id_Estado~3","Id_Version = 4");
...
CALL SARA_CRUD("UPDATE","Funcionario","Id_Estado~1","Id_Funcionario < 4");

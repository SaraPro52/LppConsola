$(document).ready(function () {
    ...
    var options = {
        ...
        success: function () {
            ...
            jso[12] = ['ProductoVirtual_Controller', '[{opcion:2,info:[' + idPv + ',' + $("#instrucciones").val() + ',' + $("#requisitos_instalacion").val() + '],arrayFun:[' + arrayAutor + '],arrayTemas:[' + arrayTemas + '],archivoNom:' + $("#myfile").val() + '}]'];
            selector[12] = null;
            datos[12] = {nombre: "btn"};

$(document).ready(function () {
    ...
    //
    //--- Peticion de consulta pv ha actualizarr
    //jso[0] = ['Version_Controller', '[{opcion:1,idFun:'+idUser+'}]'];
    
    //------ Peticion para la vista de Actualizar (llene los campos)
    //jso[0] = ['Version_Controller', '[{opcion:2,idPv:1,idVer:1}]'];
    //
    //----- Peticion de envio de datos para el registro de la actualizacion
    //jso[0] = ['ProductoVirtual_Controller', '[{opcion:2,info:['+idPv+','+ $("#instrucciones").val() + ',' + $("#requisitos_instalacion").val() + '],arrayFun:[' + arrayAutor + '],arrayTemas:[' + arrayTemas + '],archivoNom:' + $("#myfile").val() + '}]'];--- Con variables
    //jso[0] = ['Version_Controller', '[{opcion:3,info:[10,1-010-04-012,0,instrucciones3,requisitos3],arrayFun:[5,1],arrayTemas:[2-1]}]'];        

...
CREATE VIEW 18_V_Notificaciones AS(
	...
	FROM Funcionario v1 INNER JOIN Detalles_Notificacion v2 ON v1.Id_Funcionario = v2.Id_Funcionario
     ...
     INNER JOIN Rol_Funcionario v4 ON v1.Id_Funcionario = v4.Id_Funcionario
...
INNER JOIN Rol_Funcionario v7 ON v3.Id_Funcionario = v7.Id_Funcionario
INNER JOIN Rol_Funcionario v8 ON v3.Id_Funcionario = v8.Id_Funcionario
);

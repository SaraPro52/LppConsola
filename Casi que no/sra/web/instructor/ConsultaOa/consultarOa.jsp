    ...
    <article class="col-md-12">
        <div id="Tituloss">
            <div class="col-md-6">
                ...
                <input type="text" id="txtBuscarTitle" value="" class="form-control">
            </div>
            <div class="col-md-6">
                <label for="Autores">Autor: </label>
                <input type="text" id="Autores" value="" class="form-control">
            </div>
                ...
                <div id="Avando" style="display: none;">
                    <div class="col-md-12">
                        <div class="col-md-6">
                            ...
                            <br>
                            <input class="form-control" type="text" id="dataInicialA">
                        </div>
                        <div class="col-md-6">
                            <label for="dataFinalA">Fecha final:</label>
                            <br> 
                            <input class="form-control" type="text" id="dataFinalA">
                        </div>
                    </div>
                    <div class="col-md-12">

            ...
            <article class="col-md-10" id="Producto">
                <div class="col-md-16" id="consul">
                    ...
                    <div class="col-md-8">
                        ...
                        <textarea id="PvRequisitos"  class="form-control" cols="60"  rows="8"  readonly="true"></textarea>
                    </div>
                    <div class="col-md-8">
                        <label for="PvInstalacion">Instruciones de instalacion</label>
                        <textarea id="PvInstalacion" class="form-control" cols="60" rows="8" readonly="true"></textarea>
                    </div>

                ...
                <div class="col-md-12">
                    <section class="col-md-12">
                        <article class="col-md-6">
                            ...
                            <label for="DescripcionCategoria" class="col-md-12">Descripci?n:</label>
                        ...
                        <article class="col-md-6">
                            ...
                            <label for="DescripcionCategoria" class="col-md-12">Descripci?n:</label>
                            <div class="col-md-12"><input type="text" class="form-control inputs" id="DescripcionTema" placeholder="Digite Descripci?n del Tema"></div>
